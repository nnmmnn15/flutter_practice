...
import 'package:navigator_tabbar_ex_app/model/user_id.dart';
import 'package:navigator_tabbar_ex_app/view/tab_home.dart';
...
class _LogInPageState extends State<LogInPage> {
  ...
  logInButton() {
    if (idController.text == checkId && pwController.text == checkPw) {
      ...
      UserId.userPw = pwController.text.trim();
      showLoginAlert();
